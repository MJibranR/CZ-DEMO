  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-purple-500/30 rounded-full blur-3xl" />
        <div className="absolute top-20 -right-32 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
              <div className="aspect-video bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-lg flex items-center justify-center">
                <div className="text-center space-y-4">
                  <div className="w-32 h-32 mx-auto bg-white/20 rounded-lg flex items-center justify-center">
              ...
              <div className="absolute -right-4 -bottom-4 w-24 h-24 bg-purple-500/80 rounded-full flex items-center justify-center">
            ...
            <div className="absolute -right-8 top-1/4 flex flex-col space-y-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-12 h-12 bg-purple-500/50 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/30"
                >
